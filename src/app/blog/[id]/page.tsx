...
const blogs: Record<number, Blog> = {
  1: {
    ...
    image: "/blog1.jpg",
    additionalContent: `
      <h2 class="text-3xl sm:text-4xl font-bold text-center text-[#003366] mb-5 sm:mb-7">
        Explore the World's Most Breathtaking Places
      </h2>
      <p class="text-base sm:text-lg md:text-2xl text-[#221f1f] text-center mb-4 sm:mb-6 px-4 sm:px-10 md:px-20">
      ...
      <h3 class="mt-8 sm:mt-10 text-3xl sm:text-4xl font-extrabold text-center text-[#003366] mb-4">
        Top Places To Visit
      </h3>
  
      <div class="space-y-8 sm:space-y-10">
        <div>
          <h4 class="mt-8 text-2xl sm:text-3xl md:text-4xl font-bold text-[#003366] mb-4">1. Switzerland</h4>
          <p class="text-base sm:text-lg md:text-xl text-[#221f1f] mb-4">
          ...
          <div class="mt-4 space-y-3">
            <h5 class="text-lg sm:text-xl md:text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-sm sm:text-base md:text-lg text-[#221f1f]">
            ...
            <h5 class="text-lg sm:text-xl md:text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-sm sm:text-base md:text-lg text-[#221f1f]">Mid December - Mid October</p>
            <h5 class="text-lg sm:text-xl md:text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-sm sm:text-base md:text-lg text-[#221f1f]">Swiss Franc (CHF)</p>
            <h5 class="text-lg sm:text-xl md:text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-sm sm:text-base md:text-lg text-[#221f1f]">German, French, Italian, Romansh</p>
          </div>
          <Image
            src="/p1.jpg"
            alt="Switzerland"
        ...
        <!-- Repeat similar responsive blocks for other places -->

         <h4 class="mt-14 text-4xl font-bold text-[#003366] mb-14">2. Paris</h4>
          <p class="text-lg text-[#221f1f]">
          ...
          <div class="mt-6 space-y-4">
            <h5 class="text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-lg text-[#221f1f]">Some must-see attractions in Paris include: Eiffel Tower Louvre Museum, Notre-Dame Cathedral, Montmartre, and Champs-Élysées.</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-lg text-[#221f1f]">April - June, September - October</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-lg text-[#221f1f]">Euro (EUR)</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-lg text-[#221f1f]">French</p>
          </div>
          <Image src="/p2.jpg" alt="Paris" width={800} height={400} className="w-full h-auto rounded-lg" />
  
          <h4 class="mt-14 text-4xl font-bold text-[#003366] mb-14">3. Dubai</h4>
          <p class="text-lg text-[#221f1f]">
          ...
          <div class="mt-6 space-y-4">
            <h5 class="text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-lg text-[#221f1f]">Some must-see attractions in Dubai include: Burj Khalifa, Palm Jumeirah, Dubai Mall, Dubai Marina, and Dubai Fountain.</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-lg text-[#221f1f]">November - March</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-lg text-[#221f1f]">United Arab Emirates Dirham (AED)</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-lg text-[#221f1f]">Arabic, English</p>
          </div>
          <Image src="/p3.jpg" alt="Dubai" width={800} height={400} className="w-full h-auto rounded-lg" />
  
          <h4 class="mt-14 text-4xl font-bold text-[#003366] mb-14">4. Tokyo</h4>
          <p class="text-lg text-[#221f1f]">
          ...
          <div class="mt-6 space-y-4">
            <h5 class="text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-lg text-[#221f1f]">Some must-see attractions in Tokyo include: Meiji Shrine, Shibuya Crossing, Tokyo Tower, Senso-ji Temple, and Akihabara.</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-lg text-[#221f1f]">March - May, September - November</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-lg text-[#221f1f]">Japanese Yen (JPY)</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-lg text-[#221f1f]">Japanese</p>
          </div>
          <Image src="/p4.jpg" alt="Tokyo" width={800} height={400} className="w-full h-auto rounded-lg" />
  
          <h4 class="mt-14 text-4xl font-bold text-[#003366] mb-14">5. South Island, New Zealand</h4>
          <p class="text-lg text-[#221f1f]">
          ...
          <div class="mt-6 space-y-4">
            <h5 class="text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-lg text-[#221f1f]">Some must-see attractions in South Island include: Queenstown, Milford Sound, Fiordland National Park, and Mount Cook.</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-lg text-[#221f1f]">December - February</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-lg text-[#221f1f]">New Zealand Dollar (NZD)</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-lg text-[#221f1f]">English, Māori</p>
          </div>
          <Image src="/p5.jpg" alt="South Island, New Zealand" width={800} height={400} className="w-full h-auto rounded-lg" />
  
          <h4 class="mt-14 text-4xl font-bold text-[#003366] mb-14">6. Seoul, South Korea</h4>
          <p class="text-lg text-[#221f1f]">
          ...
          <div class="mt-6 space-y-4">
            <h5 class="text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-lg text-[#221f1f]">Some must-see attractions in Seoul include: Gyeongbokgung Palace, Bukchon Hanok Village, N Seoul Tower, and Myeongdong.</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-lg text-[#221f1f]">March – May, September – November</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-lg text-[#221f1f]">South Korean Won (KRW)</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-lg text-[#221f1f]">Korean</p>
          </div>
          <Image src="/p6.jpg" alt="Seoul" width={1200} height={600} className="w-full h-auto rounded-lg" />
  
          <h4 class="mt-14 text-4xl font-bold text-[#003366] mb-14">7. New York</h4>
          <p class="text-lg text-[#221f1f]">
            The Big Apple offers world-class museums, iconic landmarks like the Statue of Liberty, and endless entertainment. Central Park and Broadway are also not to be missed.
          </p>
          <div class="mt-6 space-y-4">
            <h5 class="text-2xl font-semibold text-[#003366]">Attractions</h5>
            <p class="text-lg text-[#221f1f]">Some must-see attractions in New York include: Statue of Liberty, Central Park, Times Square, Empire State Building, and Broadway.</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Best Time to Visit</h5>
            <p class="text-lg text-[#221f1f]">April – June, September – November</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Currency</h5>
            <p class="text-lg text-[#221f1f]">United States Dollar (USD)</p>
            <h5 class="text-2xl font-semibold text-[#003366]">Language</h5>
            <p class="text-lg text-[#221f1f]">English</p>
          </div>
   ...
   2: {
    ...
    additionalContent: `
      <p class="text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#1b1818] mb-8"> 
      ...
      <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-[#dd656f] mb-12">
      ...
      <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-[#1b1818] mb-10 mt-10">
      ...
      <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-[#FF6363] mb-12 mt-12">
        Key Ingredients
      </h2>
      <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-[#1b1818] mb-8">
        Here&apos;s what you&apos;ll need to make this irresistible Oreo cheesecake:
      </p>
      <ul class="list-disc pl-4 sm:pl-6 md:pl-8 text-base sm:text-lg md:text-xl lg:text-2xl text-[#1b1818] mb-8">
        <li>Oreos</li>
        <li>Butter</li>
        <li>Cream Cheese</li>
        <li>Sour Cream</li>
      ...
      <h3 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-[#FF6363] mb-10 mt-10">
        Preparing the Pan
      </h3>
      <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-[#1b1818] mb-8">
      ...
      <h3 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-[#FF6363] mb-6 mt-12">
      ...
      <h3 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-[#FF6363] mb-6 mt-10">
   ...
   3: {
    ...
    image: "/m1.jpeg",
    additionalContent: `
      <p class="text-xl sm:text-2xl text-gray-900 mb-8">
      ...
      <h2 class="text-3xl sm:text-4xl font-semibold text-gray-900 mb-8">Plot Summary</h2>
      ...
      <p class="text-xl sm:text-2xl text-gray-900 mb-10 mt-12">
      ...
      <h2 class="text-3xl sm:text-4xl font-semibold text-gray-900 mb-6">Reviews and Impact</h2>
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6">
      <div className="border-4 border-blue-200 rounded-lg p-6 max-w-4xl w-full shadow-lg">
        ...
        />
        <h1 className="text-4xl font-extrabold mt-12 text-blue-600 text-center">
          {blog.title}
        </h1>
        <p className="mt-10 text-2xl text-gray-900">{blog.description}</p>
        <div
        ...
        {/* User Comments */}
        <h3 className="text-2xl sm:text-3xl font-semibold text-[#FF6363] mb-6 mt-16">
          User Comments
        </h3>
        <div className="mb-8">
          <h4 className="text-xl sm:text-2xl font-semibold text-[#FF6363] mb-2">
            Name
          </h4>
          <input
            type="text"
            ...
            className="w-full p-4 border-2 border-[#FFB8B8] rounded-lg mb-2"
          ...
          <textarea
            ...
            className="w-full h-24 p-4 border-2 border-[#FFB8B8] rounded-lg"
            placeholder="Add your comment here..."
          />
          <button
            onClick={handleCommentSubmit}
            className="bg-[#FF6363] text-white px-6 py-5 mt-2 rounded-lg hover:bg-[#FF3B3B]"
          >
            Submit Comment
          </button>
        </div>
        ...
        {/* Display Comments */}
        <ul className="list-disc pl-8 text-lg sm:text-2xl text-[#4A4A4A]">
